        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            ...
            Flowbite
                ...
                <button
                    ...
                    aria-expanded={isMenuOpen ? "true" : "false"} // Dynamically set the aria-expanded attribute
                >
                ...
                <div
                    className={`${
                        isMenuOpen ? "block" : "hidden" // Dynamically show or hide the menu based on isMenuOpen
